...
export function getMint(txHash: Bytes, timestamp: BigInt, source: Address = ADDRESS_ZERO): Mint {
...
export function getSwap(txHash: Bytes,timestamp: BigInt, source: Address = ADDRESS_ZERO): Swap {
...
export function getRedeem(txHash: Bytes, timestamp: BigInt, source: Address = ADDRESS_ZERO): Redeem {
